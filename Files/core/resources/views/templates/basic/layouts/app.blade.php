...
<body>
    ...
    @php
        ...
        $cookieValues = $cookie?->data_values;
        $cookieStatus = $cookieValues?->status ?? null;
        $cookieDesc = $cookieValues?->short_desc ?? $cookieValues?->description ?? '';
    @endphp
    @if ($cookieStatus == Status::ENABLE && !\Cookie::get('gdpr_cookie'))
        <div class="cookies-card hide text-center">
            <div class="cookies-card__icon bg--base">
                <i class="las la-cookie-bite"></i>
            </div>
            <p class="cookies-card__content mt-4">{{ $cookieDesc }} <a href="{{ route('cookie.policy') }}"
